...
## Data  Overview.
### Historic trends: movies get more expensive to make but bring in more profit.

![Top-10 most Profitable Genres](results/Historic_Trends_Budget_Profit_plot.jpg)

### Identifying the most profitable movie genres.
![Top-10 most Profitable Genres](results/All_time_Budget_Gross_plot.jpg)
...
### Longer movies perform better at the box office.

![Action Duration](results/Profits_of_Action_Over_Duration.png)

### Movies released in early summer and after Thanksgiving perform better at the box office.

![Action Release Time](results/Release_Month_Action_Over_Time.png)

### Family-friendly movies perform better at the box office.

![Action Content Rating](results/Profit_by_Content_Rating_By_Action_plot.png)

### The most profitable Action subgenres are Adventure, Sci-Fi.

![Action Subjenres](results/Action_Budget_Profit_Genre_Subgenre_plot.png)

### Top 10 cast and crew for Adventure. 

![Action Cast](results/Top_10_Cast_names_of_Action.png)
![Action Crew](results/Top_10_Producer_of_Action.pngt.png)
![Action Crew](results/Top_10_Director_of_Action.png)
